...
function PricingCards({ monthlyPriceId }) {
    ...
    const handleUpgrade = async ()=>{
        ...
        try {
            setIsLoading(true);
            setError("");
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$billing$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createCheckoutSession"])(monthlyPriceId);
...
_s(PricingCards, "/gpCya/U6rIRAeTq9jUyGZxMtdc=", false, function() {
    return [
...
//# sourceMappingURL=src_030a1b83._.js.map